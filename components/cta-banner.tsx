  ...
  return (
    <section className="border-t border-line bg-paper-soft">
      <div className="mx-auto max-w-3xl px-6 py-16 text-center">
        ...
        <Link
          href={cta.href}
          className="mt-6 inline-block rounded bg-teal px-6 py-3 text-base font-semibold text-on-brand transition-transform hover:-translate-y-0.5 hover:shadow-teal"
        >
          {cta.label}
        </Link>
